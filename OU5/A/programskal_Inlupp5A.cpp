...
// En metod som sätter värdet på textsträngen i klassen
void Text::setText(const string &nyText)
{
  text = nyText;
}

// En metod som beräknar histogrammet av texten.
...
// En metod som skriver ut ett bokstavshistogram som en tabell med två kolumner:
